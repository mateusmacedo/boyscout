...
# Script para limpar a infraestrutura Liderança Sites
...
echo "[cleanup] Limpando infraestrutura Liderança Sites..."
...
if [[ "$IMAGES" == "--images" ]]; then
    ...
    docker rmi $(docker images "boyscout*" -q) 2>/dev/null || true
